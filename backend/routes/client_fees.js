...
router.delete("/client_fee/delete/:invoiceno", (req, res) => {
    ...
    const id = mongoose.Types.ObjectId(invoiceno); // convert string to ObjectId
    Client_fees.findByIdAndRemove(id, (err) => {
      if (err) {
